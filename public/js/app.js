...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTaskstoreJs = __webpack_require__(160);

	var _componentsTaskstoreJs2 = _interopRequireDefault(_componentsTaskstoreJs);

	var _componentsTaskactionsJs = __webpack_require__(173);

	var _componentsTaskactionsJs2 = _interopRequireDefault(_componentsTaskactionsJs);

	var _componentsTodoinputJs = __webpack_require__(174);

	var _componentsTodoinputJs2 = _interopRequireDefault(_componentsTodoinputJs);

	var _componentsTodolistJs = __webpack_require__(175);
	...
	var App = (function (_Component) {
		...
		function App() {
			...
			this.state = {
				tasks: _componentsTaskstoreJs2['default'].getState()
			};
		}
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				this.storeSubscription = _componentsTaskstoreJs2['default'].addListener(function (data) {
					return _this.handleStoreChange(data);
				});
			}
		}, {
			...
			value: function handleStoreChange() {
				this.setState({ tasks: _componentsTaskstoreJs2['default'].getState() });
			}
		}, {
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(
					'div',
					null,
					_react2['default'].createElement(_componentsTodoinputJs2['default'], null),
					_react2['default'].createElement(_componentsTodolistJs2['default'], { tasks: this.state.tasks })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __emitter = new _fbemitter.EventEmitter();
	var tasks = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _taskactions = __webpack_require__(173);
	...
	var InputArea = (function (_Component) {
		...
		function InputArea() {
			...
			_get(Object.getPrototypeOf(InputArea.prototype), 'constructor', this).call(this);
		...
		_createClass(InputArea, [{
			...
			value: function addNewTask(e) {
				e.preventDefault();
				var taskDescription = this.refs.task.value;
				...
				this.setState({ task: { description: taskDescription, priority: priority, date: currentDate, status: "Pending" } }, function () {
					_taskactions2['default'].createTask(this.state.task);
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'form',
							{ action: '#', onSubmit: this.addNewTask.bind(this) },
							_react2['default'].createElement(
								'div',
								...
								_react2['default'].createElement('input', { id: 'icon_prefix', placeholder: 'Write your todo...', ref: 'task', type: 'text', className: 'validate' }),
								_react2['default'].createElement(
									'label',
									{ htmlFor: 'icon_prefix' },
									'Todo'
	...
	var TodoLists = (function (_Component) {
	  ...
	  _createClass(TodoLists, [{
	    ...
	    value: function deleteTask(e) {
	      ...
	      if (status == true) {
	        var taskIndex = e.target.getAttribute('data-task-id');

	        _taskactions2['default'].deleteTask(taskIndex);
	      }
	    }
	  }, {
	    key: 'changeStatus',
